...
X_trainAll = pd.read_excel(f"../NG_Catboost_35/NG_CheckClusterNumber/X_train_{ngroup}.xlsx")
X_testAll = pd.read_excel(f"../NG_Catboost_35/NG_CheckClusterNumber/X_test_{ngroup}.xlsx")

...
heatmap_CC <- pheatmap(data_wide, scale = "none", cluster_rows = TRUE, cluster_cols = FALSE,
                       color = viridis(10),
                       main = "Tetracycline resistance across time in clonal-complex (4 loci same in 7 MLST scheme)",
                       fontsize=15,na_col = "white")

heatmap_CC

ggsave("/Users/user/Documents/OneDrive - Nexus365/PhD/Campy_Analysis_ALL/Figures/Heatmaps/tetracycline_heatmap_CC.png",plot=heatmap_CC, width = 50, height = 30, units = "cm",dpi = 600)

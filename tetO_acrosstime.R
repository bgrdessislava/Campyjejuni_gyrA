...
#CC overtime tetO
split_plot <- ggplot(aes(year_df$year, year_df$tetO), data = year_df) + 
  ...
  xlim(1997,2018) +
  ylim(0,1) +
  ggtitle("Tetracycline Resistance over Clonal-complex") +
  theme(plot.title = element_text(lineheight=.8, face="bold",hjust = 0.5))

split_plot

ggsave("/Users/user/Documents/OneDrive - Nexus365/PhD/Campy_Analysis_ALL/Figures/Scatterplot/tetracyclineRes_CC_year.png",plot=split_plot, width = 50, height = 30, units = "cm",dpi = 600)

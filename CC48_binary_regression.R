...
year_df<- read.csv("/Users/user/Documents/OneDrive - Nexus365/PhD/Campy_Analysis_ALL/Data/CC48_1053isolate_df_allMeta_toUSE.csv")
...
split_plot <- ggplot(aes(year_df$year, year_df$binary), data = year_df) + 
  ...
  xlab("year") + 
  ylab("resistance") +
  ggtitle("CC48 Resistance oveer ST types")

split_plot

ggsave("/Users/user/Documents/OneDrive - Nexus365/PhD/Campy_Analysis_ALL/Figures/Scatterplot/binary_CC48_STtype.png", plot=split_plot,dpi = 600)
...
split_plot_sample <- ggplot(aes(year_df$year, year_df$binary), data = year_df) + 
  ...
  xlab("year") + 
  ylab("resistance") +
  ggtitle("CC21 Resistance over time across region")


split_plot_sample 
#split_plot_ST dont run too many
ggsave("/Users/user/Documents/OneDrive - Nexus365/PhD/Campy_Analysis_ALL/Figures/Scatterplot/binary_CC_48region.png",plot=split_plot_sample,dpi = 600)

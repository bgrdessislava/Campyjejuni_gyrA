...
year_df_melt$group = ifelse(year_df_melt$clonal_complex %in% group1, 1, 
                       ifelse(year_df_melt$clonal_complex %in% group2, 2, 
                              ifelse(year_df_melt$clonal_complex %in% group3, 3, 0)))
...
#Only the ones that used for clonal complex across time analysis: 
group1_18 = c('ST-354_complex','ST-464_complex')
group2_18 = c('ST-48_complex','ST-45_complex',
           'ST-61_complex','ST-42_complex','ST-22_complex',
           'ST-283_complex')
group3_18 = c('ST-353_complex')
group4_18 = c('ST-21_complex','ST-257_complex','ST-206_complex',
...
#shows the line graph  only 0 group
